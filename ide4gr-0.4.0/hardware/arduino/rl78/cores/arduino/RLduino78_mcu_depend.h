...
#define _XCBI(sfr,bit) "\tclr1\t"#sfr"."#bit
#define _XSBI(sfr,bit) "\tset1\t"#sfr"."#bit
#define CBI(sfr, bit) __asm__ (_XCBI(sfr,bit))
#define SBI(sfr, bit) __asm__ (_XSBI(sfr,bit))

#define _XCBI2(sfr,bit) "\tclr1\t!"#sfr"."#bit
#define _XSBI2(sfr,bit) "\tset1\t!"#sfr"."#bit
#define CBI2(sfr, bit) __asm__ (_XCBI2(sfr,bit))
#define SBI2(sfr, bit) __asm__ (_XSBI2(sfr,bit))
