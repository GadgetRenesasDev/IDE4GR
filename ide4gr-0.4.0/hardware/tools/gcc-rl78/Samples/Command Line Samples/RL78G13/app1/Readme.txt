This demo flashes an LED on the RPB board for RL78/G13. Note this will not work an RSK. The
...
The make command will generate the hex file, RL78G13_led_flasher.hex which needs to be flashed
...
This tool  is able to erase, flash and verify both .hex files and S-Records
...
The blue user LED, D2, should flash after downloding the code.